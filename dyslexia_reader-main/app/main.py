...
from app.api import admin, auth, documents, mindmap, nlp, tts, readability, refine
from app.core.config import settings
from app.db.session import Base, engine
from app.db.migrate import run_migrations
from app.models import ApprovalRequest, Document, User
...
app.include_router(readability.router, prefix="/api/v1")
