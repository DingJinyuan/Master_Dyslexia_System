                ...
                <div class="header">
                    <div class="header-inner">
                        ...
                        <div class="header-right">
                            ...
                            <a href="#approval" class="nav-link" @mouseenter="handleAllHover"
                                @mouseleave="handleAllLeave" @click="openApprovalModal">
                            ...
                            <!-- 系统设置 - 绑定打开弹窗事件 -->
                            <a href="#settings" class="nav-link" @mouseenter="handleAllHover"
                                @mouseleave="handleAllLeave" @click="openSettingsModal">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <a href="#logout" class="nav-link logout" @mouseenter="handleAllHover"
                                @mouseleave="handleAllLeave">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
