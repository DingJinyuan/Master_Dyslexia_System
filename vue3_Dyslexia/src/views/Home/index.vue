  ...
  <div class="login-page">
    <div class="scene">
      ...
      <div class="main-box">
        ...
        <div class="header">
          <div class="header-inner">
            ...
            <div class="header-right">
              <!-- 管理员审批入口（仅管理员可见） -->
              <a v-if="userStore.userInfo.role === 'admin'" href="#approval" class="nav-link"
                @mouseenter="handleAllHover" @mouseleave="handleAllLeave" @click="openApprovalModal">
        ...
        <div class="welcome">
          <h1>
            {{ timeGreeting }}好，{{ userStore.userInfo.username }} 同学
            <span v-if="userStore.userInfo.role === 'admin'" class="role-badge">管理员</span>
          </h1>
