...
const doRegister = async () => {
    ...
    registerFormRef.value.validate(async (valid) => {
        if (valid) {
            try {
                const { email, username, password, role } = registerForm.value
                const mes = await registerAPI(email, username, password, role)
            ...
            <div class="register-form" ref="formAreaRef" @click.stop>
                ...
                <el-form ref="registerFormRef" :model="registerForm" :rules="loginRules" label-width="0"
                    ...
                    <el-form-item prop="role" class="form-item">
                      <el-radio-group v-model="registerForm.role" @click="showMouth">
                        <el-radio value="user" class="el-radio-custom">普通用户</el-radio>
                        <el-radio value="admin" class="el-radio-custom">管理员</el-radio>
                      </el-radio-group>
                    </el-form-item>
