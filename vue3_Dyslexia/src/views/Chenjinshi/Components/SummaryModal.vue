          ...
          <div v-else-if="result" class="summary-container">
            ...
            <div class="summary-stats">
              ...
              <div class="stat-item">
                ...
                <span class="value">{{ result.lang === 'en' ? '英文' : '中文' }}</span>
              </div>
              <div class="stat-item">
                <span class="label">原文长度：</span>
                <span class="value">{{ (originalText || '').length }} 字符</span>
              </div>
              <div class="stat-item">
                <span class="label">结果长度：</span>
                <span class="value">{{ result.refined_text?.length || 0 }} 字符</span>
              </div>
              <div class="stat-item">
                <span class="label">综合评分：</span>
                <span class="value">{{ ((result.final_score?.total_score || 0) * 100).toFixed(1) }} / 100</span>
              </div>
              <div class="stat-item">
                <span class="label">优化迭代：</span>
                <span class="value">{{ result.iterations || 0 }} 轮</span>
              </div>
            </div>
